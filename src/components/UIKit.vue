<template>
  <div class="uk-position-relative uk-visible-toggle uk-light" tabindex="-1" uk-slideshow="animation: push; min-height: 567; max-height: 800">
  ...
  <div class="uk-containe uk-padding">
